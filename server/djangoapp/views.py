"""Summary of what is happening in this file
...
def logout_user(request):
    """Log out the authenticated user and return a JSON response."""
    logout(request)
...
# Update the `get_dealerships` list of dealerships all by default
